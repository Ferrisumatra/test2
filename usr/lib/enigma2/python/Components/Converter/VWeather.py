...
class WeatherData:
	...
	def GotWeatherData(self, data = None):
		if data is not None:
			...
			self.WeatherInfo["currentWeatherText"] = weather.getAttributeNode('text').nodeValue
			...
			self.WeatherInfo["forecastTodayText"] = weather.getAttributeNode('text').nodeValue
			...
			self.WeatherInfo["forecastTomorrowText"] = weather.getAttributeNode('text').nodeValue
			...
			self.WeatherInfo["forecastTomorrow1Text"] = weather.getAttributeNode('text').nodeValue
			...
			self.WeatherInfo["forecastTomorrow2Text"] = weather.getAttributeNode('text').nodeValue
			...
			self.WeatherInfo["forecastTomorrow3Text"] = weather.getAttributeNode('text').nodeValue
